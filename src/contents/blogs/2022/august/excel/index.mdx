...
**ดูไฟล์ตัวอย่างได้ที่ [https://1drv.ms/x/s!AnqXyzBKVJbomsxqj2p9mc1oUADNKw?e=qrVcdT](https://1drv.ms/x/s!AnqXyzBKVJbomsxqj2p9mc1oUADNKw?e=qrVcdT)**
...
## การจำกัดข้องมูลทมี่กรอกให้อยู่เฉพาะใน List
...
<MDXImage name="validation-input-msg.png" caption="ตั้งค่าข้อความเวลาเลือก Cell"/>
<MDXImage name="validation-error-msg.png" caption="ตั้งค่าข้อความเวลาข้อมูลไม่เป็นไปตาม Validation criteria"/>
...
<MDXImage name="validation-format-painter.png" caption="ลาก Cell ที่ต้องการ Apply" />

และหากเราไปดูที่ Formatting rules จะเห็นว่ามันเปลี่ยนไป

<MDXImage name="validation-formatting-2.png" caption="Applied to ที่เปลี่ยนไป"/>
